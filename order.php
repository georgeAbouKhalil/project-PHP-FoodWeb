        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full_name" placeholder="<?php echo $_SESSION['username-user']; ?>" class="input-responsive" style="background-color:powderblue;" disabled>

                    <div class="order-label text-white">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 9843xxxxxx" class="input-responsive" required>

                    <div class="order-label text-white">Email</div>
                    <input type="email" name="email" placeholder="<?php echo $_SESSION['email-loggin'] ?>" class="input-responsive" style="background-color:powderblue;" disabled>    <!-- change it to take the mail from DB  from index --->
            ...
            if(isset($_POST['submit'])){
                ...
                $customer_name = $_SESSION['username-user'];
                $customer_contact = $_POST['contact'];
                $customer_email = $_SESSION['email-loggin'];
